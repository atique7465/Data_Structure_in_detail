...
public:
    ...
    ll HeapifyDown()
    {
        ...
        {
            ll smallChildIndex = getleftChildIndex(index);
    ...
    void DeleteMin()
    {   /// the complexity for the deletion of the minimum number would be O(log n ).
        if(size == 0)
        {
    ...
    void HeapSort()
    {   /// complexity: O( n log n ). sort the array in a+scending order.
